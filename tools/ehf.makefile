...
BUILD = structure example schematron xsd rules docs
...
.PHONY: default build clean ownership serve pull env docs rules structure xsd scripts_pre scripts_post schematron example
